...
public class DeviceSettings
{
    ...
    public void clickOnApplayChangeButton() throws Throwable {
    settingPage.clickApplyButton();
    }
    @And("^Verify Confirmation message pop-up$")
    public void verifyConfirmationMessagePopUp() throws Throwable {
    settingPage.propertyManagementPopUp(); //This step is failing, need to recheck
    }
